...
const TRANSLATE_X_THRESHHOLD = -SCREEN_WIDTH * .3;
...
const ListItem: React.FC<ListItemProps> = ({ task, onDismiss, simultaneousHandlers }) => {
    ...
    const rIconContainerStyle = useAnimatedStyle(() => {
        const opacity = withTiming(translateX.value < TRANSLATE_X_THRESHHOLD ? 1 : 0);
        return { opacity }
    })
    ...
    return (
        <Animated.View style={[styles.taskContainer, rTaskContainerStyle]}>
            ...
            <GestureHandlerRootView style={styles.taskInnerContainer}>
